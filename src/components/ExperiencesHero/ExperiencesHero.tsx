...
export const ExperiencesHero = () => {
  ...
  const backgroundImages = [
    "/images/experiences-hero-1.jpg",
    "/images/experiences-hero-2.jpg",
    "/images/experiences-hero-3.jpg",
  ];
  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="absolute bottom-32 right-16 w-32 h-32 bg-purple-500/20 rounded-full blur-2xl animate-pulse delay-1000" />
      ...
      <div className="absolute bottom-40 left-20 opacity-20">
        <div className="animate-bounce delay-700" style={{ animationDirection: 'reverse' }}>
          <Compass className="w-6 h-6 text-purple-300/40" />
        </div>
      </div>
      ...
      <div className="relative z-10 px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <span className="block bg-gradient-to-r from-purple-400 via-pink-300 to-purple-300 bg-clip-text text-transparent animate-fade-in-up animate-pulse" style={{ animationDelay: '0.7s' }}>
            Inolvidables
          </span>
        ...
        >
          Sumérgete en{" "}
          <span className="text-purple-300 font-semibold">aventuras</span> y{" "}
          <span className="text-purple-300 font-semibold">momentos únicos</span>{" "}
          durante tu estancia.
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="text-purple-300 group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300">
                {stat.icon}
              </div>
              <div className="text-left">
                <div className="text-white font-bold text-lg group-hover:text-purple-200 transition-colors duration-300">{stat.value}</div>
          ...
          <button
            ...
            className={`w-2 h-8 rounded-full transition-all duration-300 hover:scale-110 hover:w-3 ${
              index === currentImageIndex
                ? "bg-purple-400 shadow-lg animate-pulse"
