...
export const ServicesHero = () => {
  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="absolute bottom-32 right-16 w-32 h-32 bg-blue-500/20 rounded-full blur-2xl animate-pulse delay-1000" />
      ...
      <div className="absolute bottom-40 left-20 opacity-20">
        ...
        >
          <Coffee className="w-6 h-6 text-blue-300/40" />
        </div>
      </div>
      ...
      <div className="relative z-10 px-6 max-w-5xl mx-auto">
        ...
        >
          ...
          <span
            className="block bg-gradient-to-r from-blue-400 via-blue-300 to-cyan-300 bg-clip-text text-transparent animate-fade-in-up animate-pulse"
        ...
        >
          ...
          <span className="text-blue-300 font-semibold">perfecta</span> y sin{" "}
          <span className="text-blue-300 font-semibold">preocupaciones</span>.
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="text-blue-300 group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300">
                {stat.icon}
              </div>
          ...
          <button
            ...
            className={`w-2 h-8 rounded-full transition-all duration-300 hover:scale-110 hover:w-3 ${
              index === currentImageIndex
                ? "bg-blue-400 shadow-lg animate-pulse"
