...
export const ServicesHero = () => {
  ...
  const backgroundImages = [
    "/public/images/servicios banner.jpg",
    "/public/images/servicios banner 2.jpg",
    "/public/images/servicios banner 3.jpg",
  ];
  const stats = [
    {
...
<<<<<<< HEAD
      <div className="absolute bottom-24 left-8 sm:bottom-40 sm:left-20 opacity-20">
        ...
        >
          <Coffee className="w-4 h-4 sm:w-6 sm:h-6 text-orange-300/40" />
=======
